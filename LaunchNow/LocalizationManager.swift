...
final class LocalizationManager: ObservableObject {
    ...
    private static let translations: [AppLanguage: [L10nKey: String]] = [
        ...
        .japanese: [
            ...
            .columns: "列", .rows: "行", .appColumnsDescription: "1ページあたりのアプリ列数", .appRowsDescription: "1ページあたりのアプリ行数", .itemsPerPage: "1ページの項目数", .addApp: "アプリを追加", .resetApp: "アプリをリセット", .removeAppsDescription: "Launchpad からアプリを取り除きます（ディスク上のアプリは削除されません）。", .searchApps: "アプリを検索", .remove: "削除", .noAppsInLaunchpad: "Launchpad にアプリがありません。", .noResults: "結果がありません。",
        ...
        .korean: [
            ...
            .columns: "열", .rows: "행", .appColumnsDescription: "페이지당 앱 열 수", .appRowsDescription: "페이지당 앱 행 수", .itemsPerPage: "페이지당 항목", .addApp: "앱 추가", .resetApp: "앱 재설정", .removeAppsDescription: "Launchpad에서 앱을 제거합니다(디스크의 앱은 삭제되지 않음).", .searchApps: "앱 검색", .remove: "제거", .noAppsInLaunchpad: "Launchpad에 앱이 없습니다.", .noResults: "결과가 없습니다.",
        ...
        .simplifiedChinese: [
            ...
            .columns: "列", .rows: "行", .appColumnsDescription: "每页应用列数", .appRowsDescription: "每页应用行数", .itemsPerPage: "每页项目数", .addApp: "添加应用", .resetApp: "重置应用", .removeAppsDescription: "从 Launchpad 移除应用（不会删除磁盘上的应用）。", .searchApps: "搜索应用", .remove: "移除", .noAppsInLaunchpad: "Launchpad 中没有应用。", .noResults: "没有结果。",
        ...
        .spanish: [
            ...
            .columns: "Columnas", .rows: "Filas", .appColumnsDescription: "Número de columnas de apps por página", .appRowsDescription: "Número de filas de apps por página", .itemsPerPage: "Elementos por página", .addApp: "Agregar app", .resetApp: "Restablecer apps", .removeAppsDescription: "Quita apps de Launchpad (no elimina apps del disco).", .searchApps: "Buscar apps", .remove: "Quitar", .noAppsInLaunchpad: "No hay apps en Launchpad.", .noResults: "Sin resultados.",
        ...
        .french: [
            ...
            .columns: "Colonnes", .rows: "Lignes", .appColumnsDescription: "Nombre de colonnes d'apps par page", .appRowsDescription: "Nombre de lignes d'apps par page", .itemsPerPage: "Éléments par page", .addApp: "Ajouter une app", .resetApp: "Réinitialiser les apps", .removeAppsDescription: "Retire les apps de Launchpad (ne supprime pas les apps du disque).", .searchApps: "Rechercher des apps", .remove: "Retirer", .noAppsInLaunchpad: "Aucune app dans Launchpad.", .noResults: "Aucun résultat.",
        ...
        .german: [
            ...
            .columns: "Spalten", .rows: "Zeilen", .appColumnsDescription: "Anzahl der App-Spalten pro Seite", .appRowsDescription: "Anzahl der App-Zeilen pro Seite", .itemsPerPage: "Elemente pro Seite", .addApp: "App hinzufügen", .resetApp: "Apps zurücksetzen", .removeAppsDescription: "Apps aus Launchpad entfernen (löscht keine Apps vom Datenträger).", .searchApps: "Apps suchen", .remove: "Entfernen", .noAppsInLaunchpad: "Keine Apps in Launchpad.", .noResults: "Keine Ergebnisse.",
        ...
        .portugueseBrazil: [
            ...
            .columns: "Colunas", .rows: "Linhas", .appColumnsDescription: "Número de colunas de apps por página", .appRowsDescription: "Número de linhas de apps por página", .itemsPerPage: "Itens por página", .addApp: "Adicionar app", .resetApp: "Redefinir apps", .removeAppsDescription: "Remove apps do Launchpad (não exclui apps do disco).", .searchApps: "Buscar apps", .remove: "Remover", .noAppsInLaunchpad: "Nenhum app no Launchpad.", .noResults: "Nenhum resultado.",
        ...
        .indonesian: [
            ...
            .columns: "Kolom", .rows: "Baris", .appColumnsDescription: "Jumlah kolom app per halaman", .appRowsDescription: "Jumlah baris app per halaman", .itemsPerPage: "Item per halaman", .addApp: "Tambah app", .resetApp: "Atur ulang app", .removeAppsDescription: "Hapus app dari Launchpad (tidak menghapus app dari disk).", .searchApps: "Cari app", .remove: "Hapus", .noAppsInLaunchpad: "Tidak ada app di Launchpad.", .noResults: "Tidak ada hasil.",
